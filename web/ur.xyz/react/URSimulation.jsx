...
export default function URSimulation() {
    ...
    useEffect(() => {
        ...
        const stats = { 
            totalFeesUr: 0, urBought: 0, urDistributed: 0, urAbsorbed: 0, 
        ...
        function animate() {
            ...
            particles = particles.filter(pt => {
                ...
                if(pt.p >= 1) {
                    ...
                    updateUIState(); // Push updates to React safely
                    return false;
                }
                return true;
            });
        ...
        <div className="simulation-wrapper">
            ...
            <div className="dashboard">
                <div className="logo-container">
                    <img src="/UR.png" alt="$UR Logo" />
                    <p className="logo-subtitle">Own your network. Own your privacy.</p>
                    <a href="https://ur.io" target="_blank" rel="noreferrer" className="app-link">Get the app</a>
                </div>

                <div className="header">PROTOCOL LEDGER</div>
                
                <div className="stat-grid">
                    <div className="stat-box">
                        <div className="label">Total Fees ($UR)</div>
                        <div className="val-ur">{fmt(uiStats.totalFeesUr)}</div>
                    </div>
                    <div className="stat-box">
                        <div className="label">Total Data</div>
                        <div className="val-data">{fmt(uiStats.dataPB)} PB</div>
                    </div>
                    <div className="stat-box">
                        <div className="label">Total Networks</div>
                        <div className="val-white">{Math.floor(uiStats.displayedNetworks).toLocaleString()}</div>
                    </div>
                    <div className="stat-box">
                        <div className="label">Block Height</div>
                        <div className="val-white">#{uiStats.blockHeight}</div>
                    </div>
                    <div className="stat-box full-width">
                        <div className="label">Total $UR Supply</div>
                        <div className="val-supply">{fmt(uiStats.totalSupply)}</div>
                    </div>
                    <div className="stat-box">
                        <div className="label">Tokens Purchased</div>
                        <div className="val-ur">{fmt(uiStats.urBought)}</div>
                    </div>
                    <div className="stat-box">
                        <div className="label">Total Distributed</div>
                        <div className="val-ur">{fmt(uiStats.urDistributed)}</div>
                    </div>
                    <div className="stat-box">
                        <div className="label">$UR Absorbed</div>
                        <div className="val-burn">{fmt(uiStats.urAbsorbed)}</div>
                    </div>
                    <div className="stat-box full-width">
                        <div className="label">Status Held ($UR)</div>
                        <div className="val-ur">{fmt(uiStats.totalHeldUr)}</div>
                    </div>
                </div>

                <div className="disclaimer">This is a simulation of the $UR economy.</div>
            </div>
